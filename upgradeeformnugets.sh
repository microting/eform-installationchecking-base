...
if (( "$GIT_STATUS" > 0 )); then
	...
	dotnet add Microting.InstallationCheckingBase/Microting.InstallationCheckingBase.csproj package Microting.eForm
	dotnet add Microting.InstallationCheckingBase/Microting.InstallationCheckingBase.csproj package Microting.eFormApi.BasePn
